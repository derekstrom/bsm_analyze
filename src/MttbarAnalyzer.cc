...
void MttbarAnalyzer::jets(const Event *event, const Electron *el)
{
...
MttbarAnalyzer::PBP4 MttbarAnalyzer::leptonicLeg(const Event *event,
        const Electron *el,
        const Jets &jets)
{
...
MttbarAnalyzer::PBP4 MttbarAnalyzer::hadronicLeg(const Event *event,
        const Jet *wjet,
        const Jets &jets)
{
    PBP4 p4(new LorentzVector());
